...
const addLicenseLocation = async (req, res) => {
    try {
        ...
        console.log(
            "[controllers][controllers][licenses][addLicenseLocation]: JOi Result",
            result
        );
        ...
        console.log(
            "[controllers][controllers][licenses][addLicenseLocation]: ",
            alreadyExists
        );
        ...
        console.log("[controllers][controllers][licenses][addLicenseLocation] :  Error", err);
        //trx.rollback
        res.status(500).json({
