...
const changeLicenseStatus = async (req, res) => {
    try {
        ...
        console.log(
            "[controllers][controllers][licenses]changeLicenseStatus: JOi Result",
            result
        );
        ...
        console.log("[controllers][controllers][licenses][changeLicenseStatus] :  Error", err);
        //trx.rollback
        res.status(500).json({
...
module.exports = changeLicenseStatus;
