...
const unhealthyEntry = async (req, res) => {
    ...
    console.log(
        "[controllers][plants][unhealthyEntry]: payload", payload
    );
    ...
    console.log(
        "[controllers][plants][unhealthyEntry]: JOi Result",
        result
    );
    ...
    try {
        ...
        let insertData = {
            ...
            observationType: ObservationTypes.Unhealthy,
        ...
        console.log('Unhealthy Entry Txn Header insert record: ', insertData);
        ...
        await knex.transaction(async (trx) => {
            ...
            if(allPlants){
                ...
                console.log('Unhealthy Entry Txn images record all plants: ', sqlStr);
                ...
                console.log('Unhealthy Entry Txn images_tags record all plants: ', sqlStr);
                ...
                console.log('Unhealthy Entry Txn remarks_master record all plants: ', sqlStr);
                ...
                console.log('Unhealthy Entry Txn images record: ', sqlStr);
                ...
                console.log('Unhealthy Entry Txn images_tags record: ', sqlStr);
                ...
                console.log('Unhealthy Entry Txn remarks_master record: ', sqlStr);
            ...
            let userActivity = {
                ...
                description: `${req.me.name} marked ${insertedRecord.totalPlants} plant(s) unhealthy of plant lot '${payload.plantLotNo}' on ${moment(currentTime).format('DD MMM YYYY hh:mm:ss a')} `,
                createdBy: userId,
                createdAt: currentTime,
                trx: trx
            }
        ...
        return res.status(200).json({
            ...
            message: 'Plants unhealthy entry successfully.'
        });
    } catch (err) {
        console.log("[controllers][plants][unhealthyEntry] :  Error", err);
        //trx.rollback
        res.status(500).json({
