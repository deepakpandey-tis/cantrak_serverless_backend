 ...
 */
        ...
        (
            SELECT pl.id, pl."lotNo", pl."specieId", pl."strainId"
        ...
        SELECT distinct pcl.id, pcl."lotNo", pcl."specieId", pcl."strainId" FROM plant_current_locations pcl WHERE NOT "isFinalHarvest" ORDER BY pcl."lotNo" desc
        `;
