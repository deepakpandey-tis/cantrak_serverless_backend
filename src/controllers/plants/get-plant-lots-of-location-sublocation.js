...
const getPlantLotsOfLocationSubLocation = async (req, res) => {
    try {
        ...
        console.log("[controllers][plants][getPlantLotsOfLocationSubLocation] :  Error", err);
...
module.exports = getPlantLotsOfLocationSubLocation;
