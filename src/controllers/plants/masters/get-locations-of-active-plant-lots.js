...
const getLocationsOfActivePlantLots = async (req, res) => {
    try {
        ...
        console.log("[controllers][plants][masters][getLocationsOfActivePlantLots] :  Error", err);
        res.status(500).json({
...
module.exports = getLocationsOfActivePlantLots;
