...
const getSubLocationsOfActivePlantLots = async (req, res) => {
    try {
        ...
        console.log("[controllers][plants][masters][getSubLocationsOfActivePlantLots] :  Error", err);
        res.status(500).json({
...
module.exports = getSubLocationsOfActivePlantLots;
