...
const getPlant = async (req, res) => {
    try {
        ...
        FROM plant_lots pl LEFT JOIN licenses lic ON pl."licenseId" = lic.id
        , plants p , plant_growth_stages pgs, growth_stages gs, locations l, sub_locations sl
        , companies c, strains s, species s2, plant_locations pl2
