...
const getHealthyTxnList = async (req, res) => {
    try {
        ...
        sqlWhere = ` WHERE pot."orgId" = ${orgId} AND pot."observationType" = ${ObservationTypes.Healthy}`;
        ...
        //console.log('getHealthyTxnList sql: ', sqlSelect + sqlFrom + sqlWhere);
        ...
        //console.log('getHealthyTxnList: ', sqlStr);
        ...
        console.log("[controllers][plants][getHealthyTxnList] :  Error", err);
...
module.exports = getHealthyTxnList;
