 ...
 */
        ...
        sqlSelect = `SELECT DISTINCT ON (hpl.id, it.id) hpl.*, pl."lotNo" "plantLotNo", pl.name "plantLotName", l."name" "plantLocation"
        ...
        , CASE WHEN it2."txnType" IS NOT NULL THEN true ELSE false END "isUsed"
        `;

        sqlFrom = ` FROM harvest_plant_lots hpl
        LEFT JOIN item_txns it2 ON hpl."orgId" = it2."orgId" AND hpl."companyId" = it2."companyId" AND hpl."lotNo" = it2."lotNo" AND it2.quantity < 0
        , plant_lots pl, locations l
