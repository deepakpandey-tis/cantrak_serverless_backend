...
const getSupplierList = async (req, res) => {
    try {
        ...
        //console.log('getSupplierList sql: ', sqlSelect + sqlFrom + sqlWhere);
        ...
        //console.log('getSupplierList: ', sqlStr);
        ...
        console.log("[controllers][administration-features][suppliers][getSupplierList] :  Error", err);
