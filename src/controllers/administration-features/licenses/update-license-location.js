...
const updateLicenseLocation = async (req, res) => {
    try {
        ...
        console.log(
            "[controllers][administration-features][licenses]updateLicenseLocation: JOi Result",
            result
        );
        ...
        console.log(
            "[controllers][administration-features][licenses][updateLicenseLocation]: ",
            alreadyExists
        );
        ...
        console.log("[controllers][administration-features][licenses][updateLicenseLocation] :  Error", err);
        res.status(500).json({
