...
const deleteLicenseObjective = async (req, res) => {
    try {
        ...
        console.log(
            "[controllers][administration-features][licenses]deleteLicenseObjective: JOi Result",
            result
        );
        ...
        console.log("[controllers][administration-features][licenses][deleteLicenseObjective] :  Error", err);
        //trx.rollback
        res.status(500).json({
