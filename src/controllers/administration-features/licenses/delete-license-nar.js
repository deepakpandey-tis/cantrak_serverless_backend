...
const deleteLicenseNar = async (req, res) => {
    try {
        ...
        console.log(
            "[controllers][administration-features][licenses]deleteLicenseNar: JOi Result",
            result
        );
        ...
        console.log("[controllers][administration-features][licenses][deleteLicenseNar] :  Error", err);
        //trx.rollback
        res.status(500).json({
...
module.exports = deleteLicenseNar;
