...
const updateTraceLot = async (req, res) => {
    try {
        ...
        const schema = Joi.object().keys({
            ...
            umId: Joi.number().default(null).optional(),
        ...
        console.log(
            "[controllers][trace-lots][updateTraceLot]: JOi Result",
            result
        );
        ...
        return res.status(200).json({
            ...
            message: 'Trace QR detail updated successfully.'
        });
    } catch (err) {
        console.log("[controllers][trace-lots][updateTraceLot] :  Error", err);
        //trx.rollback
        res.status(500).json({
