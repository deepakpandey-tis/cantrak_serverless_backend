...
router.get(
  "/get-user-pending-approval-list",
  authMiddleware.isAuthenticated,
  userMiddleware.customerInfo,
...
router.post(
  "/get-user-parcel-details",
  authMiddleware.isAuthenticated,
  userMiddleware.customerInfo,
  facilityBookingController.getParcelDetails
);

router.post(
  "/get-parcel-approval-list",
  authMiddleware.isAuthenticated,
  userMiddleware.customerInfo,
