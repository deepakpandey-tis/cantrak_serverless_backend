...
const serviceDetailsController = require('../../controllers/users/servicedetails');
...
router.get('/get-priority-all-list', authMiddleware.isAuthenticated, userMiddleware.customerInfo, serviceDetailsController.getPriorityAllList);
