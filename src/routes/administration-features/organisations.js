...
router.get('/get-organisation-details-theme', organisationsController.getOrganisationDetailsForTheme);
...
router.post('/update-organisation-theme/:id', authMiddleware.isAuthenticated, organisationsController.updateOrganisationTheme);
