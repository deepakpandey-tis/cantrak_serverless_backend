...
router.post('/add-people', authMiddleware.isAuthenticated, trimmerSpace.signUpTrimmer, peopleController.addPeople)
...
router.post('/update-people', authMiddleware.isAuthenticated, trimmerSpace.signUpTrimmer, peopleController.updatePeople)
