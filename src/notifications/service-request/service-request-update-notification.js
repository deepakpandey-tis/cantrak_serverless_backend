...
const serviceRequestUpdateNotification = {
    send: async (sender, receiver, data, allowedChannels = ALLOWED_CHANNELS) => {
        try {
            ...
            if (SHOULD_QUEUE) {
                ...
                await notification.send(sender, receiver, JSON.parse(JSON.stringify(data)), allowedChannels, serviceRequestUpdateNotification);
...
module.exports = serviceRequestUpdateNotification;