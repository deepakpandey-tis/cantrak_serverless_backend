...
const parcelCanceledNotification = {
    send:async (sender, receiver, data, allowedChannels = ALLOWED_CHANNELS) =>{
        try{
            ...
            if (SHOULD_QUEUE) {
                ...
                await notification.send(sender, receiver, JSON.parse(JSON.stringify(data)), allowedChannels, parcelCanceledNotification);
       ...
       console.log("In App Notification")
        ...
        data = {
            ...
            payload: {
                ...
                body: `Hi,Your parcel has been cancel.`,
    ...
    sendLineNotification: async (sender, receiver, data) => {
        data = {
            receiverId: receiver.id,
            message: `Hi ${receiver.name} Your parcel has been cancel.`
        };
...
module.exports = parcelCanceledNotification;